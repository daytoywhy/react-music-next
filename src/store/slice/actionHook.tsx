...
import {setPlayingState, setSequenceList, setPlaylist, setPlayMode, setCurrentIndex, setFullScreen} from './appSlice'
export default function useAppSelector() {
  ...
  const changeModeStore = (state,mode) => {
  ...
  const removeSongStore = (state,song) => {
